...
const squareNumber = function( num ) {
  const numSqr = num * num;
  console.log(`The result of squaring the number ${ num } is ${ numSqr }.`);
  return num;
};
// *********************************************************************************************************************************************************************************************
//
...
//
    ...
    const area = Math.PI * pow( radius,2);
...
//
   ...
   const areaPercentOfSqrHalfNum = percentOf( circleArea, sqrHalfNum );

   console.log(`halfNum: ${halfNum}, sqrHalfNum: ${sqrHalfNum}, circleArea: ${circleArea}, areaPercent...: ${areaPercentOfSqrHalfNum}`);
 }
